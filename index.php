...
<body class="home">
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/k2.png" alt="" width="18%"> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        if (!empty($_SESSION["user_id"])) {
                            ...
                            $query = mysqli_query($db, "SELECT username, email FROM users WHERE u_id = '$user_id'");
                        ...
                        <li class="nav-item dropdown">
                            <a class="" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="images/user0-icn.png" alt="user" class="profile-pic" width="30px" />
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="">
                                    <?php
                                    if (!empty($_SESSION["user_id"])) {
                                        echo '<li><a href="user_profile.php"><i class="fa fa-user"></i> Profile</a></li>';
    ...
    <section class="hero bg-image" data-image-src="images/img/2.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>"YumCart: Seamless Food Ordering System" </h1>
                ...
                <div class="col-sm-8">
                    <div class="restaurants-filter pull-right">
                        <nav class="primary pull-left">
                            <ul>
                                <li>
                                    <h1><a href="#" class="selected" data-filter="*">all</a></h1>
                                </li>
                                <?php
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h3><a href="dishes.php?res_id=' . $rows['rs_id'] . '" >' . $rows['title'] . '</a></h3> <span>' . $rows['address'] . '</span>
																</div>
